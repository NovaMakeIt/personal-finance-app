...
export function TitleCardComponents({name, buttonName}) {
    return(<div className="w-full flex justify-between">
        ...
        <button className="flex items-center space-x-150 group">
            <h3 className="text-Grey500 text-TextPreset4 font-TextPreset4 group-hover:text-Grey900 ">{buttonName}</h3>
            <IconCaretRight />
        </button>
    </div>)
}